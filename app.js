...
mongoose.connect(NODE_ENV === "production" ? MONGO_URI : 'mongodb://127.0.0.1:27017/mestodb')
  .then((res) => console.log("Подключение удалось: " + res.connections[0]._connectionString))
  .catch((err) => console.log(err + " Подключение к БД не удалось"));
